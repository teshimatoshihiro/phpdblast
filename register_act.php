...
// ///////////////////////////////////////////////////////
// $sql = 'INSERT INTO users_table (id,username,occupation,department,residential,email,password,is_admin,created_at,updated_at,deleted_at) VALUES(NULL,:username,:occupation,:department,:residential,:email,:password,:is_admin,now(), now(),:deadline)';
// ////////////////////////////////////////////////////////
